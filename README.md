...
- **이은지**
    - 커플 가계부
        ...
        - 입출금 내역 추가
        - 특정 조건으로 내역 검색
    - 연애고사(KakaoTalk API, Google Gemini API)
        - 기초 설문 조사 응시
        - 상대방의 설문 결과가 존재하지 않을 때 재촉 가능(KakaoTalk API)
        - 연애 고사 응시(Google Gemini API)
        - 이전 고사 문제 및 정답, 점수 조회
    - 오늘 뭐먹지?(Google Gemini API)
        - 사다리 타기
    - 오늘의 질문
        - 자정에 오늘의 질문 자동 등록
        - 오늘의 질문 및 과거 질문, 답변 조회
        - 답변 등록 및 수정
    - AI 연애 상담(Google Gemini API)
      	- 연애 상담 안내문 조회(쿠키)
        - 기존 상담 내역 조회
        - 질문 후 AI에게 답변 받기
...
##### 커플 가계부 - 조회
> - 가계부 조회
![가계부-조회](https://github.com/user-attachments/assets/a5c03576-2492-4eea-b5eb-1d7fddd60396)
##### 커플 가계부 - 추가
> - 입출금 내역 추가
![가계부-추가](https://github.com/user-attachments/assets/96175ecc-627f-465f-a204-262b2478392d)
##### 커플 가계부 - 검색
> - 특정 조건으로 내역 검색
![가계부-검색](https://github.com/user-attachments/assets/5d6e152e-3475-4c9e-b9b1-244af1946002)
#### 🟡 연애고사
##### 연애고사 - 설문
> - 기초 설문 조사
![연애고사-기초설문](https://github.com/user-attachments/assets/7e971ada-f51a-48d0-94f2-cc77930c43fc)
##### 연애고사 - 재촉하기
...
> - 기존에 풀던 고사가 존재하는 경우
![연애고사-기존에풀던](https://github.com/user-attachments/assets/b8ee3bf7-4833-4704-8b10-7986779b0fa6)
> - 새로운 고사 생성
![연애고사-새로운](https://github.com/user-attachments/assets/dc5d74c4-fc1f-4fed-a675-c528985e6409)
##### 연애고사 - 이전 고사 조회
> - 이전 고사 문제 및 정답, 점수 조회
![연애고사-과거조회](https://github.com/user-attachments/assets/0d565401-3571-41ff-954d-459240e80f07)
#### 🟡 오늘 뭐먹지?
##### 오늘 뭐먹지? - 사다리 타기
> - 사다리 타기(메뉴 생성 : Google Gemini API)
![오늘뭐먹지](https://github.com/user-attachments/assets/8f39b953-764a-42f1-99ea-92aa1d563d7f)
#### 🟡 오늘의 질문
##### 오늘의 질문 - 조회
> - 오늘의 질문 조회
![오늘의질문-수정](https://github.com/user-attachments/assets/9b73de2b-2dda-41c6-8994-8205af9a8934)
##### 오늘의 질문 - 답변하기
> - 오늘의 질문에 답변하기
![오늘의질문-답변](https://github.com/user-attachments/assets/6ffd3a2d-648b-41e5-8050-bd553d36b97c)
##### 오늘의 질문 - 답변 수정하기
> - 오늘의 질문 답변 수정하기
![오늘의질문-조회](https://github.com/user-attachments/assets/a050459a-3faf-42a1-a91b-518946022fe6)
##### 오늘의 질문 - 추가
> - 자정에 자동으로 INSERT
> - 2024.10.18 기준
![2024-10-18](https://github.com/user-attachments/assets/994fb540-f3f5-4053-97f2-a6be9788a1db)
> - 2024.10.21 기준
![2024-10-21](https://github.com/user-attachments/assets/61b32f81-96cf-4cef-9647-452caab62770)
#### 🟡 AI 연애 상담
##### AI 연애 상담 - 조회 및 질문
> - 사용 안내문 및 기존 상담 내역 조회
![연애상담-쿠키,조회](https://github.com/user-attachments/assets/f6512ce9-fa1d-4420-84fc-2923243fe52d)
> - AI 연애 상담(답변 : Google Gemini API)
![연애상담-질문및답변](https://github.com/user-attachments/assets/2b366753-9861-400a-97a5-5320a33735c2)
