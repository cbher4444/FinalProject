...
public class test {
    private static final String API_KEY = "AIzaSyBpZ1NaMkkfmSIOHcMPs74kzGDAcnNHz6Q"; // Enter your API key here
    private static final String MODEL_NAME = "gemini-pro"; // Select the model to use
    ...
    private static void handleErrorResponse(HttpURLConnection conn, int responseCode) throws Exception {
