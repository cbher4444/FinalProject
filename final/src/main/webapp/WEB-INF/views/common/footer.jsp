            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                    	<c:choose>
							<c:when test="${ empty loginUser or loginUser.status ne 'Y' or loginUser.email eq 'admin@email.com'}">
								<!-- case1. 로그인 전 or 커플등록이 안됨 or 탈퇴대기 중 -->
								<h2>UsTwo</h2>
							</c:when>
							<c:otherwise>
								<!-- case3. 로그인 후 and 커플등록완료 -->
								<h2>
									<c:choose>
                    ...
                    <div class="col-md-6 col-md-offset-3 text-center copyright">
                        <p>Copyright 2024 <a href="https://github.com/cbher4444/FinalProject" target="_blank">4랑해조❤️</a>. All Rights Reserved. <br>
